...
DEPENDS = "astra-camera cartographer-ros depthimage-to-laserscan depthimage-to-pointcloud2 joy launch ros2run teleop-twist-joy tf2-ros turtlebot2-drivers"
