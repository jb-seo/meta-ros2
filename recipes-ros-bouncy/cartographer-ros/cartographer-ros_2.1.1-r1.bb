...
DEPENDS = "ament-cmake cartographer cartographer-ros-msgs console-bridge eigen libpcl-all-dev lua5.2-dev nav-msgs pcl-conversions rclcpp sensor-msgs tf2 tf2-eigen tf2-msgs tf2-ros urdf urdfdom-headers visualization-msgs yaml-cpp"
