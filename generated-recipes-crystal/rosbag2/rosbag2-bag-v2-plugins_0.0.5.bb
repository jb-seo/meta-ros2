...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/crystal/rosbag2_bag_v2_plugins/0.0.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7547da679e1d54d64fab399490086f80"
SRC_URI[sha256sum] = "9ae762dead59b7be992010bfaa6bf55f3f49a60a03534293785877a875ac391a"
S = "${WORKDIR}/rosbag2-release-release-crystal-rosbag2_bag_v2_plugins-0.0.5-0"
