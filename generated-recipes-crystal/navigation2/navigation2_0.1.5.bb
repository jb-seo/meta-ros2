...
SRC_URI = "https://github.com/SteveMacenski/navigation2-release/archive/release/crystal/navigation2/0.1.5-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
...
S = "${WORKDIR}/navigation2-release-release-crystal-navigation2-0.1.5-0"
