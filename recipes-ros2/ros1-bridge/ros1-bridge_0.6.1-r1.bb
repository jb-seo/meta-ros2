...
DEPENDS = "actionlib-msgs   builtin-interfaces diagnostic-msgs gazebo-msgs geometry-msgs nav-msgs pkgconfig python3-pyyaml rclcpp rcutils rmw-implementation-cmake rosidl-cmake rosidl-parser sensor-msgs shape-msgs std-msgs std-srvs stereo-msgs tf2-msgs trajectory-msgs visualization-msgs"
