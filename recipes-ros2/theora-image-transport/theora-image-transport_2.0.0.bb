...
DEPENDS = "ament-cmake builtin-interfaces cv-bridge image-transport libogg libtheora pluginlib rclcpp rosidl-default-generators rosidl-default-runtime std-msgs"
