...
DEPENDS = "ament-cmake ament-index-cpp ament-index-python class-loader cv-bridge geometry-msgs libpcl-all libpcl-all-dev message-filters object-analytics-msgs object-msgs pcl-conversions rclcpp sensor-msgs std-msgs"
