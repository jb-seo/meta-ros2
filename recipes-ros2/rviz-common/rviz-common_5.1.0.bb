...
DEPENDS = " geometry-msgs libqt5-core libqt5-gui libqt5-opengl libqt5-widgets pluginlib qtbase5-dev rclcpp resource-retriever rviz-assimp-vendor rviz-ogre-vendor rviz-rendering sensor-msgs std-msgs tf2 tf2-geometry-msgs tf2-ros tinyxml-vendor urdf yaml-cpp-vendor"
