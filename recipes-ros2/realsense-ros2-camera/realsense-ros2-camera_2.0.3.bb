...
DEPENDS = "ament-cmake builtin-interfaces cv-bridge eigen image-transport librealsense2 rclcpp realsense-camera-msgs rmw-implementation rosidl-default-generators rosidl-default-runtime sensor-msgs std-msgs tf2-ros"
