...
DEPENDS = "ament-cmake python3-catkin-pkg-modules python3-matplotlib python3-numpy python-qt-binding qt-gui-py-common rclpy rqt-gui rqt-gui-py rqt-py-common std-msgs"
