...
DEPENDS = "ament-cmake geometry-msgs laser-geometry libpcl-all-dev map-msgs message-filters nav2-dynamic-params nav2-msgs nav2-util nav2-voxel-grid nav-msgs pluginlib rclcpp sensor-msgs std-msgs tf2 tf2-geometry-msgs tf2-ros tf2-sensor-msgs visualization-msgs"
