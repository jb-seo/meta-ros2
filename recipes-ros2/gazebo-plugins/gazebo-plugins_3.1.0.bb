...
DEPENDS = "ament-cmake camera-info-manager gazebo-dev gazebo-ros geometry-msgs image-transport nav-msgs rclcpp sensor-msgs std-msgs tf2-geometry-msgs tf2-ros"
