...
include ${ROS_LAYERDIR}/recipes-ros/rmw-fastrtps-cpp/rmw-fastrtps-cpp-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rmw-fastrtps-cpp/rmw-fastrtps-cpp-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rmw-fastrtps-cpp/rmw-fastrtps-cpp-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rmw-fastrtps-cpp/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rmw-fastrtps-cpp/${BPN}-${PV}.inc
