...
ROS_BUILD_DEPENDS = "ament-index-python ros2cli python3-catkin-pkg-modules python3-empy python3-pkg-resources"
...
include ${ROS_LAYERDIR}/recipes-ros/ros2pkg/ros2pkg-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ros2pkg/ros2pkg-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ros2pkg/ros2pkg-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ros2pkg/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ros2pkg/${BPN}-${PV}.inc
