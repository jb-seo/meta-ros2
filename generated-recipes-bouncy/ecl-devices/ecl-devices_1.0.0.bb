...
include ${ROS_LAYERDIR}/recipes-ros/ecl-devices/ecl-devices-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-devices/ecl-devices-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-devices/ecl-devices-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-devices/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-devices/${BPN}-${PV}.inc
