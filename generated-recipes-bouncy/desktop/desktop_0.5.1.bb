...
include ${ROS_LAYERDIR}/recipes-ros/desktop/desktop-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/desktop/desktop-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/desktop/desktop-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/desktop/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/desktop/${BPN}-${PV}.inc
