...
include ${ROS_LAYERDIR}/recipes-ros/ecl-sigslots-lite/ecl-sigslots-lite-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-sigslots-lite/ecl-sigslots-lite-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-sigslots-lite/ecl-sigslots-lite-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-sigslots-lite/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-sigslots-lite/${BPN}-${PV}.inc
