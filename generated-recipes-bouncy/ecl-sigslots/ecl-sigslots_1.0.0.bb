...
include ${ROS_LAYERDIR}/recipes-ros/ecl-sigslots/ecl-sigslots-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-sigslots/ecl-sigslots-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-sigslots/ecl-sigslots-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-sigslots/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-sigslots/${BPN}-${PV}.inc
