...
include ${ROS_LAYERDIR}/recipes-ros/ament-cpplint/ament-cpplint-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ament-cpplint/ament-cpplint-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-cpplint/ament-cpplint-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-cpplint/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-cpplint/${BPN}-${PV}.inc
