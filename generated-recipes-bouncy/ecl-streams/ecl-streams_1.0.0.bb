...
include ${ROS_LAYERDIR}/recipes-ros/ecl-streams/ecl-streams-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-streams/ecl-streams-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-streams/ecl-streams-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-streams/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-streams/${BPN}-${PV}.inc
