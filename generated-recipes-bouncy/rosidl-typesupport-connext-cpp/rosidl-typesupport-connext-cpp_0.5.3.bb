...
include ${ROS_LAYERDIR}/recipes-ros/rosidl-typesupport-connext-cpp/rosidl-typesupport-connext-cpp-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rosidl-typesupport-connext-cpp/rosidl-typesupport-connext-cpp-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rosidl-typesupport-connext-cpp/rosidl-typesupport-connext-cpp-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rosidl-typesupport-connext-cpp/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rosidl-typesupport-connext-cpp/${BPN}-${PV}.inc
