...
include ${ROS_LAYERDIR}/recipes-ros/ecl-math/ecl-math-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-math/ecl-math-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-math/ecl-math-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-math/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-math/${BPN}-${PV}.inc
