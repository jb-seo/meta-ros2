...
include ${ROS_LAYERDIR}/recipes-ros/ecl-manipulators/ecl-manipulators-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-manipulators/ecl-manipulators-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-manipulators/ecl-manipulators-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-manipulators/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-manipulators/${BPN}-${PV}.inc
