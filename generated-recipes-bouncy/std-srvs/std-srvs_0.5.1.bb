...
include ${ROS_LAYERDIR}/recipes-ros/std-srvs/std-srvs-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/std-srvs/std-srvs-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/std-srvs/std-srvs-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/std-srvs/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/std-srvs/${BPN}-${PV}.inc
