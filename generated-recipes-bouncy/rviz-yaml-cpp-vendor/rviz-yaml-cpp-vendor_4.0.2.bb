...
include ${ROS_LAYERDIR}/recipes-ros/rviz-yaml-cpp-vendor/rviz-yaml-cpp-vendor-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rviz-yaml-cpp-vendor/rviz-yaml-cpp-vendor-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rviz-yaml-cpp-vendor/rviz-yaml-cpp-vendor-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rviz-yaml-cpp-vendor/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rviz-yaml-cpp-vendor/${BPN}-${PV}.inc
