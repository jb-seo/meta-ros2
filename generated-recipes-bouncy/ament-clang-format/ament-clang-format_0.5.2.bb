...
ROS_BUILD_DEPENDS = "clang-format-native"
...
include ${ROS_LAYERDIR}/recipes-ros/ament-clang-format/ament-clang-format-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ament-clang-format/ament-clang-format-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-clang-format/ament-clang-format-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-clang-format/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-clang-format/${BPN}-${PV}.inc
