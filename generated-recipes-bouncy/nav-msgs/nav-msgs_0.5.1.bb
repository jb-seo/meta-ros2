...
include ${ROS_LAYERDIR}/recipes-ros/nav-msgs/nav-msgs-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/nav-msgs/nav-msgs-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/nav-msgs/nav-msgs-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/nav-msgs/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/nav-msgs/${BPN}-${PV}.inc
