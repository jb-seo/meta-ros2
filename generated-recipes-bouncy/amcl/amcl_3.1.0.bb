...
ROS_TEST_DEPENDS = "map-server-native"
...
include ${ROS_LAYERDIR}/recipes-ros/amcl/amcl-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/amcl/amcl-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/amcl/amcl-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/amcl/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/amcl/${BPN}-${PV}.inc
