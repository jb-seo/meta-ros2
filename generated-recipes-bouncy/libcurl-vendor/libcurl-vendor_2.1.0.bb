...
include ${ROS_LAYERDIR}/recipes-ros/libcurl-vendor/libcurl-vendor-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/libcurl-vendor/libcurl-vendor-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/libcurl-vendor/libcurl-vendor-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/libcurl-vendor/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/libcurl-vendor/${BPN}-${PV}.inc
