...
ROS_TEST_DEPENDS = "ament-cmake-pytest ament-lint-auto ament-lint-common launch launch-testing"
...
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/demos/demo-nodes-cpp-native-common-${PV}.inc
