...
include ${ROS_LAYERDIR}/recipes-ros/ecl-formatters/ecl-formatters-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-formatters/ecl-formatters-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-formatters/ecl-formatters-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-formatters/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-formatters/${BPN}-${PV}.inc
