...
include ${ROS_LAYERDIR}/recipes-ros/ecl-converters-lite/ecl-converters-lite-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-converters-lite/ecl-converters-lite-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-converters-lite/ecl-converters-lite-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-converters-lite/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-converters-lite/${BPN}-${PV}.inc
