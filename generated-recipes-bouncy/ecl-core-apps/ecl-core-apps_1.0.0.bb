...
include ${ROS_LAYERDIR}/recipes-ros/ecl-core-apps/ecl-core-apps-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-core-apps/ecl-core-apps-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-core-apps/ecl-core-apps-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-core-apps/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-core-apps/${BPN}-${PV}.inc
