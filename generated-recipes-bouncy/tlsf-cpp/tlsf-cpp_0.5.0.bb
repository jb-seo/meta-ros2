...
ROS_TEST_DEPENDS = "ament-cmake-gtest-native ament-lint-auto-native ament-lint-common-native rmw-implementation-cmake-native"
...
include ${ROS_LAYERDIR}/recipes-ros/tlsf-cpp/tlsf-cpp-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/tlsf-cpp/tlsf-cpp-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tlsf-cpp/tlsf-cpp-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tlsf-cpp/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tlsf-cpp/${BPN}-${PV}.inc
