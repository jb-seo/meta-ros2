...
include ${ROS_LAYERDIR}/recipes-ros/ecl-console/ecl-console-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-console/ecl-console-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-console/ecl-console-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-console/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-console/${BPN}-${PV}.inc
