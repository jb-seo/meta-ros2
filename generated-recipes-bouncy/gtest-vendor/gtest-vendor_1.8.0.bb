...
include ${ROS_LAYERDIR}/recipes-ros/gtest-vendor/gtest-vendor-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/gtest-vendor/gtest-vendor-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/gtest-vendor/gtest-vendor-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/gtest-vendor/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/gtest-vendor/${BPN}-${PV}.inc
