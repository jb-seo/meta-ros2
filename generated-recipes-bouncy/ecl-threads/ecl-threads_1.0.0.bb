...
include ${ROS_LAYERDIR}/recipes-ros/ecl-threads/ecl-threads-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-threads/ecl-threads-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-threads/ecl-threads-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-threads/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-threads/${BPN}-${PV}.inc
