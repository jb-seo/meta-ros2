...
include ${ROS_LAYERDIR}/recipes-ros/rosidl-typesupport-cpp/rosidl-typesupport-cpp-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rosidl-typesupport-cpp/rosidl-typesupport-cpp-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rosidl-typesupport-cpp/rosidl-typesupport-cpp-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rosidl-typesupport-cpp/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rosidl-typesupport-cpp/${BPN}-${PV}.inc
