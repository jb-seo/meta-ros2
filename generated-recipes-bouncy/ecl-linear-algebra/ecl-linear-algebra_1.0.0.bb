...
include ${ROS_LAYERDIR}/recipes-ros/ecl-linear-algebra/ecl-linear-algebra-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-linear-algebra/ecl-linear-algebra-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-linear-algebra/ecl-linear-algebra-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-linear-algebra/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-linear-algebra/${BPN}-${PV}.inc
