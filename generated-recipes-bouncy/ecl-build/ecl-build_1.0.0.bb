...
include ${ROS_LAYERDIR}/recipes-ros/ecl-build/ecl-build-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-build/ecl-build-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-build/ecl-build-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-build/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-build/${BPN}-${PV}.inc
