...
include ${ROS_LAYERDIR}/recipes-ros/ament-pep8/ament-pep8-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ament-pep8/ament-pep8-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-pep8/ament-pep8-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-pep8/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-pep8/${BPN}-${PV}.inc
