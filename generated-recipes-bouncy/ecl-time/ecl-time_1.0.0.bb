...
include ${ROS_LAYERDIR}/recipes-ros/ecl-time/ecl-time-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-time/ecl-time-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-time/ecl-time-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-time/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-time/${BPN}-${PV}.inc
