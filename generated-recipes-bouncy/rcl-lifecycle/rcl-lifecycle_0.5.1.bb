...
include ${ROS_LAYERDIR}/recipes-ros/rcl-lifecycle/rcl-lifecycle-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rcl-lifecycle/rcl-lifecycle-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rcl-lifecycle/rcl-lifecycle-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rcl-lifecycle/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rcl-lifecycle/${BPN}-${PV}.inc
