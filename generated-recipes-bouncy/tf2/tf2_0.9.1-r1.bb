...
include ${ROS_LAYERDIR}/recipes-ros/tf2/tf2-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/tf2/tf2-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tf2/tf2-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tf2/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tf2/${BPN}-${PV}.inc
