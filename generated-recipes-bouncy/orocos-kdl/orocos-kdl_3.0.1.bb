...
ROS_TEST_DEPENDS = "cppunit-native"
...
include ${ROS_LAYERDIR}/recipes-ros/orocos-kdl/orocos-kdl-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/orocos-kdl/orocos-kdl-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/orocos-kdl/orocos-kdl-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/orocos-kdl/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/orocos-kdl/${BPN}-${PV}.inc
