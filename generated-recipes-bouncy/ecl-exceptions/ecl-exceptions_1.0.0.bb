...
include ${ROS_LAYERDIR}/recipes-ros/ecl-exceptions/ecl-exceptions-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-exceptions/ecl-exceptions-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-exceptions/ecl-exceptions-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-exceptions/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-exceptions/${BPN}-${PV}.inc
