...
include ${ROS_LAYERDIR}/recipes-ros/ecl-command-line/ecl-command-line-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-command-line/ecl-command-line-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-command-line/ecl-command-line-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-command-line/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-command-line/${BPN}-${PV}.inc
