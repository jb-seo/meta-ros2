...
include ${ROS_LAYERDIR}/recipes-ros/rviz-assimp-vendor/rviz-assimp-vendor-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rviz-assimp-vendor/rviz-assimp-vendor-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rviz-assimp-vendor/rviz-assimp-vendor-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rviz-assimp-vendor/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rviz-assimp-vendor/${BPN}-${PV}.inc
