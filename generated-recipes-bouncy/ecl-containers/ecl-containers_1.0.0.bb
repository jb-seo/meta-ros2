...
include ${ROS_LAYERDIR}/recipes-ros/ecl-containers/ecl-containers-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-containers/ecl-containers-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-containers/ecl-containers-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-containers/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-containers/${BPN}-${PV}.inc
