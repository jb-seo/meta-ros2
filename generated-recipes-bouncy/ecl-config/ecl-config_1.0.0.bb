...
include ${ROS_LAYERDIR}/recipes-ros/ecl-config/ecl-config-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-config/ecl-config-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-config/ecl-config-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-config/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-config/${BPN}-${PV}.inc
