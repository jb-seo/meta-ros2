...
include ${ROS_LAYERDIR}/recipes-ros/tf2-msgs/tf2-msgs-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/tf2-msgs/tf2-msgs-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tf2-msgs/tf2-msgs-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tf2-msgs/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/tf2-msgs/${BPN}-${PV}.inc
