...
include ${ROS_LAYERDIR}/recipes-ros/ament-cppcheck/ament-cppcheck-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ament-cppcheck/ament-cppcheck-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-cppcheck/ament-cppcheck-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-cppcheck/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ament-cppcheck/${BPN}-${PV}.inc
