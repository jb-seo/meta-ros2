...
include ${ROS_LAYERDIR}/recipes-ros/ecl-filesystem/ecl-filesystem-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-filesystem/ecl-filesystem-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-filesystem/ecl-filesystem-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-filesystem/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-filesystem/${BPN}-${PV}.inc
