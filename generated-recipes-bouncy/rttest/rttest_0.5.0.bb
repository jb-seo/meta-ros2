...
include ${ROS_LAYERDIR}/recipes-ros/rttest/rttest-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/rttest/rttest-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rttest/rttest-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rttest/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rttest/${BPN}-${PV}.inc
