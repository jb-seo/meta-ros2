...
include ${ROS_LAYERDIR}/recipes-ros/examples-rclpy-minimal-client/examples-rclpy-minimal-client-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/examples-rclpy-minimal-client/examples-rclpy-minimal-client-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/examples-rclpy-minimal-client/examples-rclpy-minimal-client-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/examples-rclpy-minimal-client/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/examples-rclpy-minimal-client/${BPN}-${PV}.inc
