...
include ${ROS_LAYERDIR}/recipes-ros/ecl-errors/ecl-errors-common.inc
include ${ROS_LAYERDIR}/recipes-ros2/ecl-errors/ecl-errors-common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-errors/ecl-errors-common-${PV}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-errors/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/ecl-errors/${BPN}-${PV}.inc
